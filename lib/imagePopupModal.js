...
function imgPopupModal(e){
    ...
    console.log($('.image-clickable-container div').width(),'shubham today check 1');
    console.log($('#img01').width(),'shubham today check 2');
    var position = ($('.image-clickable-container div').width() - $('#img01').width())/2 - 5 + 'px';
    $('.close').css('right',position);
