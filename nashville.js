...
function selectMode(elem) {
  ...
  switch (mode) {
    ...
    case "Landmarks":
      ...
      if(!map.previousselectedlandmark){
        $('#selection_img').hide();
      }
      $("#selection_description").html(
        "Select a landmark/street marker on the map and information for that landmark will appear here"
      );
